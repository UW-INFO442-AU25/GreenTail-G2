...
function NavigationBar() {
  ...
  return (
    <header className="bg-white shadow-lg fixed top-0 left-0 right-0 z-50 h-16">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 md:px-8 py-4 h-full">
          ...
          <ul className="flex gap-8 items-center" role="menubar">
            ...
            {user ? (
              <li className="flex items-center gap-2">
                <Link 
                  to="/profile"
                  className="flex items-center gap-2 text-gray-700 hover:text-emerald-600 transition-colors duration-300 py-2"
                ...
                <button 
                  onClick={logout} 
                  className="ml-2 text-sm text-red-600 hover:text-red-800 py-2 px-2"
                  aria-label="Log out"
                >
                  Logout
                </button>
