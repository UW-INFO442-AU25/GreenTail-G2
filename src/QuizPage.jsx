...
function QuizPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-green-50 via-green-100 to-blue-50 pt-32 pb-20">
            ...
            <ul className="space-y-4 mb-6">
              <li className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-800 rounded-full flex items-center justify-center">
                  <img src="/icons/check-icon.svg" alt="Check" className="w-3 h-3 filter brightness-0 invert" />
                </div>
